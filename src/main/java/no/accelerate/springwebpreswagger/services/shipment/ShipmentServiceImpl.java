...
public class ShipmentServiceImpl implements ShipmentService {
    ...
    @Override
    public Shipment findByIdAndCustomerId(Integer id, Integer customerId) {
        return shipmentRepository.findByIdAndCustomerId(id, customerId);
    }

    @Override
    public List<Shipment> findAllShipmentsByCustomerId(int id) {
